...
class air_spider():
    def __init__(self, city, year):
        ...
        with open(self.city + '-' + self.year + '.csv', 'w', newline='') as csv_file:
    ...
    def get_content(self, url):
        response = requests.post(url,data={'CITY':self.city,'V_DATE':self.date,"E_DATE":self.date})
        text = response.text
        return text
